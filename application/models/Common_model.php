...
class Common_model extends CI_Model
{
  ...
  public function delete_where($tb_name,$column,$column_id){
	...
	public function getToken($user_id=0) { 
		$usrm_user = $this->get_user($user_id);	
		$agentID = $usrm_user['agent_id'];		
		$head = array(
			'Content-Type' => $usrm_user['content_type'],
			'Consumer-Key' => $usrm_user['consumer_key'],
		);
	...
	{			
	    $_where = NULL;
		$_where .= "WHERE prename_th = '".$name."'";
		$sql = "SELECT * FROM std_prename ".$_where;
	...
	function getPrename($id)
	{			
	    $_where = NULL;
		$_where .= "WHERE pren_code = '".$id."'";
		$sql = "SELECT * FROM std_prename ".$_where;
		$query = $this->db->query($sql);
		return $query->row_array();
	...
	public function getDead($id=0){
		$_where = NULL;
		$_where .= "WHERE pid = '".$id."'";
		$_where .= "AND  fnrl_info.delete_datetime IS NULL";
		$sql = "SELECT fnrl_info.fnrl_id,pers_info.* FROM fnrl_info 
		LEFT JOIN pers_info ON pers_info.pers_id = fnrl_info.pers_id
		".$_where;
		$query = $this->db->query($sql);
		//echo $this->db->last_query();
		return $query->row_array();
	...
	public function getAdaptenvirDouble($id=0){
		$_where = NULL;
		$_where .= "WHERE pid = '".$id."'";
		$_where .= "AND  impv_home_info.delete_datetime IS NULL";
		$sql = "SELECT impv_home_info.imp_home_id,pers_info.* FROM impv_home_info 
		LEFT JOIN pers_info ON pers_info.pers_id = impv_home_info.pers_id
		".$_where;
		$query = $this->db->query($sql);
		//echo $this->db->last_query();
		return $query->row_array();
    ...
    public function getDifficultDouble($id=0){
		$_where = NULL;
		$_where .= "WHERE pid = '".$id."'";
		$_where .= "AND  diff_info.delete_datetime IS NULL";
		$sql = "SELECT diff_info.diff_id,pers_info.* FROM diff_info 
		LEFT JOIN pers_info ON pers_info.pers_id = diff_info.pers_id
		".$_where;
		$query = $this->db->query($sql);
		//echo $this->db->last_query();
		return $query->row_array();
    ...
    public function getWelfareDouble($id=0){
		$_where = NULL;
		$_where .= "WHERE pid = '".$id."'";
		$_where .= "AND  adm_info.delete_datetime IS NULL";
		$sql = "SELECT adm_info.adm_id,pers_info.* FROM adm_info 
		LEFT JOIN pers_info ON pers_info.pers_id = adm_info.pers_id
		".$_where;
		$query = $this->db->query($sql);
		//echo $this->db->last_query();
		return $query->row_array();
    ...
    public function getVolunteerDouble($id=0){
		$_where = NULL;
		$_where .= "WHERE pid = '".$id."'";
		$_where .= "AND  volt_info.delete_datetime IS NULL";
		$sql = "SELECT volt_info.volt_id,pers_info.* FROM volt_info 
		LEFT JOIN pers_info ON pers_info.pers_id = volt_info.pers_id
		".$_where;
		$query = $this->db->query($sql);
		//echo $this->db->last_query();
		return $query->row_array();
