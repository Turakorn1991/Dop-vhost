        ...
        if(isset($token)){
            try{
                ...
                if($pers_info_reg != null){
                    // default 
                    $this->db->where(array('pren_code'=>$pers_info_reg->pren_code));
                    $prefix_r = $this->db->get('std_prename')->row();
                    $reg_pid = $pers_info_reg->pid;
                    $reg_prefix = isset($prefix_r->prename_th) ? $prefix_r->prename_th : "";
                    $reg_name = $pers_info_reg->pers_firstname_th;
                    $reg_lastname = $pers_info_reg->pers_lastname_th;
                    $reg_laser_id =  empty($pers_info_reg->laser_id)?"" : $pers_info_reg->laser_id;
                    $reg_birthdate = (empty($pers_info_reg->date_of_birth) || $pers_info_reg->date_of_birth == null)? "" : $this->time_format($pers_info_reg->date_of_birth);;
                    $reg_tel = $pers_info_reg->tel_no;
                    $reg_email = $pers_info_reg->email_addr;
                    $id = "";
                    $laser_id = "";
                    $prefix = "";
                    $name = "";
                    ...
                    if($user_gold != null){
                        ...
                        if($pers_info != null){
                            ...
                            $birth_date = (empty($pers_info->date_of_birth) || $pers_info->date_of_birth == null)? "" : $this->time_format($pers_info->date_of_birth);
                            $tel = $pers_info->tel_no;
                            $email = $pers_info->email_addr;
                            ...
                            $prefix_i = $this->db->get('std_prename')->row();
                            $prefix = isset($prefix_i->prename_th)?$prefix_i->prename_th:"";
                        }
                    }
