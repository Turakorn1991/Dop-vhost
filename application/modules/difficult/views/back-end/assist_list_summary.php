            ...
            <div id="chartTab-1" class="tab-pane active">
                <div class="panel-body row">
                  <div class="col-xs-12 col-sm-12">
                    ...
                    <center>
                      <div id="chartdiv">
                        <iframe width="100%" height="550" src="https://app.powerbi.com/view?r=eyJrIjoiY2RiMWU5OGEtZjdiZi00NzYyLWIwMDktYTlkMGMxMWExMDc2IiwidCI6IjliMzg4YjE3LTk4MjItNDczNy04YTdhLWFkYWM2Yzc5Mjc4YiIsImMiOjN9" frameborder="0" allowFullScreen="true"></iframe>
                      </div>
                    </center>
                  </div>
                  <div class="col-xs-12 col-sm-12">
