    ...
    <div class="container-fluid">
       ...
       <div class="form-group row">
         ...
         <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
           ...
           <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
             <input type="text" data-column="7" class="form-control column_filter" style="width: 80px;" id="col7_filter" name="start_age" value="0" />
           </div>
           <div class="col-xs-12 col-sm-1" style="padding-top: 12px;"><h3><label>ถึง</label></h3></div>
           <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
             <input type="text" data-column="8" class="form-control column_filter" style="width: 80px;" id="col8_filter" name="end_age" value="100" />
           </div>
           <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
       ...
       <div class="form-group row">
         ...
         <div class="col-xs-12 col-sm-3">
           <select class="form-control" id="statusoper">
              ...
              <option value="date_of_reg">วันที่ยื่นคำขอ</option>
              <option value="date_of_pay">วันที่ได้รับการสงเคราะห์</option>
        ...
        <div class="row">
         <div class="col-xs-12 col-sm-3">
          <h3><label for="col9_filter">หน่วยงาน (ผู้บันทึกข้อมูล):</label></h3>
         </div>
         <div class="col-xs-12 col-sm-6">
             <?php
