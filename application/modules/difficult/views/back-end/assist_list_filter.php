...
<!-- search-->
  ...
  <div class="well" style="background-color: rgb(255, 255, 255);">
     <div class="container-fluid">
          ...
          <div class="col-xs-12 col-sm-4">
            ...
            <div class="form-group" id="data_5" data-date-format="dd-mm-yyyy">
              <div class="input-daterange input-group " id="datepicker">
                ...
                <input type="text" class="form-control" name="end" value="" placeholder="เลือกถึงวันที่" style="height: 34px;" readonly/>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-3">
            <h3><label for="col12_filter">หน่วยงาน (ผู้บันทึกข้อมูล):</label></h3>
          </div>
          <div class="col-xs-12 col-sm-6">
              <?php
