...
/*            return $this->common_model->custom_query("select A.*,B.*,C.*,D.*,E.*,F.*,G.*,CONCAT(B.pers_firstname_th, ' ', B.pers_lastname_th) as name 
        ...
        */
        ...
        public function get_diffInfo($diff_id){
...
*/
        ...
        public function getOnce_reqChanel2($chn_code='') {
        ...
        public function getQol($id=''){
            $queryString = " SELECT * FROM pers_qol_indicators where pers_id = (SELECT A.pers_id FROM pers_info as A
            JOIN pers_info as B on A.pid = B.pid  where A.pid = {$id} )";
            return rowArray($this->common_model->custom_query($queryString)) ; 
