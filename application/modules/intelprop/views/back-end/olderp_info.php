              ...
              <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-1 " style="width: 15%">
                  <input title="รหัสไปรษณีย์" placeholder="ระบุรหัสไปรษณีย์" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_zipcode]" id="addr_zipcode" value="<?php echo @$addr_info['addr_zipcode']; ?>" />
                    ...
                    <div class="form-group row">
                      <div class="col-xs-12 col-sm-3 ">
                        <label for="" class="col-2 col-form-label">ลักษณะความพิการ</label>
                      </div>
                      <div class="col-xs-12 col-sm-3 dropdown">
                        <select title="ลักษณะความพิการ" class="form-control" name="pers_info[healthy]" id="healthy">
                            <option value="">เลือกลักษณะความพิการ</option>
                            <?php foreach($health_issues as $hea){ ?>
                              <?php if($hea != 'อื่นๆ'){ ?>
                                <option value="<?php echo $hea ?><" <?php echo ( $wisd_info['healthy'] ==  $hea ? 'selected' : '' ) ?>><?php echo $hea ?></option>
                              <?php  } ?>
                            <?php  } ?>
                          </select>
                      </div>
