     ...
     <div class="container-fluid">
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-12 col-sm-3" style="padding-top: 12px;">
                ...
                <option value="ไม่ทราบ">ไม่ทราบ (Not Know)</option> 
           ...
           <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
            ...
            <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
              <input type="text" data-column="9" class="form-control column_filter" style="width: 80px;" id="col9_filter" name="end_age" value="200" />
            </div>
            <div class="col-xs-12 col-sm-1" style="padding-top: 12px;">
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-12 col-sm-3">
            <select class="form-control" id="statusoper">
               ...
               <option value="date_of_svy">วันที่รับการสำรวจ</option>
               <option value="date_of_consi">วันที่พิจารณาอนุมัติ</option>
               <option value="date_of_finish">วันที่ดำเนินการแล้วเสร็จ</option>
          ...
          <div class="col-xs-12 col-sm-4">
            ...
            <div class="form-group" id="data_5" data-date-format="dd-mm-yyyy">
              <div class="input-daterange input-group " id="datepicker">
                <input type="text" class="input-sm form-control" name="start" value="" placeholder="เลือกตั้งแต่วันที่" style="height: 34px;" readonly/>
                <span class="input-group-addon">ถึง</span>
                <input type="text" class="input-sm form-control" name="end" value="" placeholder="เลือกถึงวันที่" style="height: 34px;" readonly/>
              </div>
            </div>
...
<script>
    ...
    $('#datepicker').change(function(){
        ...
        $('#col6_filter').val('');
        $('#col7_filter').val('');
         if(statusoper == 'date_of_svy'){
           $('#col5_filter').val(composedate);
         }else if(statusoper == 'date_of_consi'){
           $('#col6_filter').val(composedate);
         }else if(statusoper == 'date_of_finish'){
    ...
    $('#statusoper').change(function(){
      var statusoper  = $('#statusoper').val();
      var composedate = !$('input[name=start]').val()?'*':$('input[name=start]').val()+'_'+$('input[name=end]').val();
      $('#col5_filter').val('');
      $('#col6_filter').val('');
      $('#col7_filter').val('');
      if(statusoper == 'date_of_svy'){
