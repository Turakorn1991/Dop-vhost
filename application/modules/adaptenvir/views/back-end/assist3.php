                    ...
                    <div class="tabs-container">
                      <ul class="nav nav-tabs">
                        ...
                        <div class="tab-content">
                            <div id="tab-1" <?php if($usrpm['app_id']==32){?>class="tab-pane active" <?php }else{?> class="tab-pane"<?php }?>>
                                <div class="panel-body">
                                 ...
                                 <div class="form-group row">
                                      <?php
                                      $imp_home_id = '';
                                      $imp_home_id_original = $impv_home_info['imp_home_id'];
                                          ...
                                          <div class="panel panel-default" style="border: 0">
                                                ...
                                                <div class="panel-body" style="border:0; padding: 20px;">
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">ค่าใช้จ่ายการซ่อมแซมบ้านพักผู้สูงอายุ (บาท)</label>
                                                              <input title="ค่าใช้จ่ายการซ่อมแซมบ้านพักผู้สูงอายุ (บาท)" placeholder="ค่าใช้จ่ายการซ่อมแซมบ้านพักผู้สูงอายุ (บาท)" class="form-control" type="text" onkeyup="nonthnumber(this)"  name="impv_home_info[case_budget]" value="<?php echo @$impv_home_info['case_budget'];?>"/>
                                                          </div>

                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">ค่าบริหารจัดการ (บาท)</label>
                                                              <input title="่ค่าบริหารจัดการ (บาท)" id="case_budget" placeholder="ค่าบริหารจัดการ (บาท)" class="form-control" type="text" onkeyup="nonthnumber(this)"  name="impv_home_info[mgt_budget]" value="<?php echo @$impv_home_info['mgt_budget'];?>"/>
                                                          </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="panel panel-default" style="border: 0">
                                                                <div class="panel-heading">
                                                                  <h4>รูปภาพถ่ายประกอบ</h4>  
                                                                  <h5>*รับรูปภาพขนาดไม่เกิน 5 MB(ขนาดพิเซล 5000 x 3500 พิกเซลโดยประมาณ) ต่อรูปภาพ และอัปโหลดได้ไม่เกินครั้งละ 10 รูปภาพ</h5>
                                                                </div>
                                                            
                                                            </div>
                                                        </div>
                                                <!-- <div class="panel panel-default" style="border: 0">
                                                <div class="panel-heading"><h4>ภาพถ่ายประกอบ</h4>  </div>
                                                <div class="panel-body" style="border:0; padding: 20px;"> -->

                                                        <!-- UPDATE IMG-->
                                                        <div class="form-group row">
                                                        <div class="col-xs-12 col-sm-12" id="parent_0">          
                                                             <div class="col-xs-12 col-sm-4 col-lg-3 element photo-contianer"   style="margin-top: 20px; height:300px; word-wrap: break-word;" >
                            ...
                            <div id="tab-2" <?php if($usrpm['app_id']==32){?>class="tab-pane active" <?php }else{?> class="tab-pane"<?php }?>>
                                <div class="panel-body">
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                          ...
                                          <?php //if(($process_action!='Edit')&&($process_action!='Edited')){
                                                  $test_photo_query = $this->common_model->query(
                                                    "SELECT a.* 
                                                    FROM impv_home_info_photo a
                                                    where a.impv_home_id =  $imp_home_id_original and a.insert_datetime not like '' and a.insert_datetime is not null  
                                                    order by  a.impv_home_photo_id ASC, a.insert_datetime ASC,a.impv_home_info_title ASC;")->result_array();
                                          ...
                                          ?>
                                                  ...
                                                  <div class="col-xs-12 col-sm-4 col-lg-3 element"   style="margin-top: 20px; height:300px; word-wrap: break-word;">
                                                        <div style="margin-bottom:20px;">  
                                                          <text>
                                                            <!-- <b>ชื่อไฟล์ : <?php echo $photo_query_result['impv_home_photo_file']; ?><b><br> -->
                                                            <b>ภาพที่ : <?php echo ++$i; ?><b><br>
                                                            ชื่อภาพ : <?php echo $photo_query_result['impv_home_info_title']; ?><br>
                                                            เพิ่มเมื่อวันที่ : <?php echo 'วันที่ '.formatDateThai1($date).' เวลา '.$time ?>
                                                          </text>
                                                        </div>
                                                        <div class="container2">
                                                          <img src="<?php echo base_url();?>assets/modules/adaptenvir/images/uploads/<?php echo $photo_query_result['impv_home_photo_file']; ?>" alt="..."  class="image">
                                                          <div class="overlay">
                                                            <input type="checkbox" class="che_del" > <span class="glyphicon glyphicon-trash trash" aria-hidden="true" onclick="opn_photo(this)" data-id="<?php echo $imp_home_id_original;?>" data-photoid="<?php echo $photo_query_result['impv_home_photo_id'];?>" ></span>
                                                          </div>
                                                        </div>
                                                 </div>
...
<!-- Delete Modal Del Photos -->
<div id="dltModel_photo" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="dltbtnYes_photo" type="button" class="btn btn-danger">ตกลง</button>
