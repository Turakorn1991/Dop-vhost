<script>
  ...
  var export_url = '<?php echo site_url('report/D0/xls');?>';
  var export_url_ktb = '<?php echo site_url('report/D0_ktb/xls');?>';
          ...
          <table id="dtable" class="table table-striped table-bordered table-hover dataTables-example" style="margin-top: 0px !important; width:100% !important;">
            <thead style="font-size: 15px;">
                  <tr>
                      ...
                      <th style="width:10% !important;" class="text-center">วันที่ได้รับหนังสือยินยอม</th>
                      <th style="width:10% !important;" class="text-center">วันที่เสร็จสิ้น</th>
                      <th style="width:10% !important;" class="text-center">ช่องทางการแจ้งเรื่อง</th>
                      <th style="width:10% !important;" class="text-center">หน่วยงาน</th>
              ...
              <div class="modal-body">
                  <div class="row">
                    ...
                    ?>
                        ...
                        <?php if(!isset($tmp1['perm_status'])) {?>
                        readonly
                        <?php }else{?> href="#" onclick="exportExcel(0);" <?php }?> title="รายงานผู้สูงอายุที่ได้รับการปรับปรุงบ้าน" >
                        <i class="fa fa-file-excel-o" aria-hidden="true"></i> รายงานผู้สูงอายุที่ได้รับการปรับปรุงบ้าน 
                        </a>
                    </div>   
                    <div class="col-xs-12 col-sm-12 text-left" style="margin-bottom: 10px;">
                        <a style="color: #333; font-size: 16px;" class="navbar"  
