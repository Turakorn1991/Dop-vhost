                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                              ...
                              ?>
                                <a <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                    <?php //echo site_url('funeral/assist2/Edit/'.$fnrl_info['fnrl_id']);?>
                                  <?php }else if($process_action!='Add'){?> href="#" <?php }?> <?php if($usrpm['app_id']==23){?>aria-expanded="true" <?php }?>>(2) สงเคราะห์</a>
                            </li>
                        </ul>
                                   ...
                                   <!--
                                    ...
                                    <div class="panel-group" style="margin-bottom: 0px;">
                                          <div class="panel panel-default" style="border: 0">
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 has-error" style="padding: 3px 15px;">
                                                      ...
                                                      <div class="input-group" style="width: 295px;">
                                                             ...
                                                             <input type="hidden" id="req_pers_id" name="fnrl_info[req_pers_id]" value="req_pers_id=<?php echo $fnrl_info['req_pers_id'];?>">
                                                             <input type="hidden" id="pid_id" name="impv_pid[pid]" value="<?php echo $fnrl_info['req_pid'];?>">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 has-error" style="padding: 3px 15px;">                                                      
                                                      ...
                                                      <script>
                                                        ...
                                                        // var inputpid = "#req_pid";//เอาไอดีมาจากinput
                                                        // var bt_spid = "#bt_req_pid";//ปุ่ม
                                                        ...
                                                        //   $("#req_reg_addr_id").val(value.req_reg_addr_id);
                                                    ...
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="req_name"> <?php echo $req_prename['prename_th'].' '.$fnrl_info['req_name']; ?> </div>

                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span></div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="req_date_of_birth_text"> <?php echo $fnrl_info['req_date_of_birth'];?> </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <span id="req_reg_addr"> <?php echo @$fnrl_info['req_reg_add_info']; ?> </span> </div>
                                                  </div>
                                              ...
                                              <input title="ตำแหน่ง" placeholder="ระบุตำแหน่ง" class="form-control" type="text" onkeyup="numberandth(this)" name="fnrl_info[req_position]" value="<?php echo $fnrl_info['req_position'];?>"/>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">หน่วยงาน</label>
                                              <input title="หน่วยงานต้นสังกัด" placeholder="ระบุหน่วยงานต้นสังกัด (ชื่อเต็มเท่านั้น)" class="form-control" onkeyup="numberandth(this)" type="text" name="fnrl_info[req_org]" value="<?php echo $fnrl_info['req_org'];?>"/>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">เกี่ยวข้องเป็น</label>
                                              <input title="ความสัมพันธ์กับผู้สูงอายุ" placeholder="ระบุความสัมพันธ์กับผู้สูงอายุ" class="form-control" onkeyup="thvalidate(this)" type="text" name="fnrl_info[req_relation]" value="<?php echo $fnrl_info['req_relation'];?>"/>
                                                    </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                            <div class="col-xs-12 col-sm-3">
                                              ...
                                              <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 02XXXXXXX ต่อ XXX" class="form-control" onkeyup="thnodash(this)" type="text" name="fnrl_info[req_tel_home]" value="<?php echo $fnrl_info['req_tel_home'];?>"/>
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (มือถือ)</label>
                                              <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" onkeyup="thnodash(this)" type="text" name="fnrl_info[req_tel_no_mobile]" value="<?php echo $fnrl_info['req_tel_no_mobile'];?>"/>
                                            </div>
                                       
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="" class="col-2 col-form-label">ที่อยู่อีเมล</label>
                                              <input title="ที่อยู่อีเมล" placeholder="ตัวอย่าง me@mail.com" class="form-control" onkeyup="nonthai(this)" type="email" name="fnrl_info[req_email_addr]" value="<?php echo $fnrl_info['req_email_addr'];?>"/>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                              <div class="col-xs-12 col-sm-3">
                                                ...
                                                <input title="ระบุ" placeholder="ระบุ" class="form-control" type="text"  name="fnrl_info[req_bank_acc_no]" value="<?php echo @$fnrl_info['req_bank_acc_no']; ?>"/>
                                              </div>
                                              <div class="col-xs-12 col-sm-3 dropdown">
                                                <label class="col-2 col-form-label">ชื่อธนาคาร</label>
                                                <select id="bank_code" title="ชื่อธนาคาร" placeholder="เลือกธนาคาร" class="form-control" name="fnrl_info[req_bank_name]" >
                                                    <option value="">เลือกธนาคาร</option>
                                                        <?php $tmp_cr = $this->common_model->custom_query("select * from std_bank");
                                                              foreach ($tmp_cr as $row) { ?>
                                                              <option value="<?php echo $row['bank_code'];?>" <?php if($row['bank_code'] == $fnrl_info['req_bank_name']){ echo "selected";} ?>><?php echo $row['bank_name']; ?></option>
                                                              <?php } ?>
                                                </select>
                                              </div>
                                              <div class="col-xs-12 col-sm-3">
                                                <label class="col-2 col-form-label">ธนาคารอื่นๆ</label>
                                                <input id="other_bank" title="ระบุ" placeholder="อื่นๆ (ระบุ)" class="form-control" type="text"  name="fnrl_info[req_bank_other]" value="<?php echo $fnrl_info['req_bank_other']; ?>" <?php if($fnrl_info['bank_other'] == "") { echo "disabled";} ?> />
                                              </div>
                                            </div>
                                                <script type="text/javascript">
                                              ...
                                              <div class="panel-body" style="border:0; padding: 20px;">
                                                <div class="alert alert-danger alert-excep-age <?php echo ( isset($fnrl_info['age']) && $fnrl_info['age'] < 60 ? "" : "hide" ) ?>">
                                                  <strong>แจ้งเตือน!</strong> การสงเคราะห์ในการจัดการศพผู้สูงอายุตามประเพณี ผู้สูงอายุจะต้องมีอายุมากกว่า 60 ปี
                                                </div> 
                                          ...
                                          <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                         <div class="input-group" style="width: 295px;">
                                                           ...
                                                           <input  type="hidden" id="pers_id" name="fnrl_info[pers_id]" value="pers_id=<?php echo $fnrl_info['pers_id'];?>">
                                                           <input type="hidden" id="pid_id2" name="impv_pid2[pid]" value="<?php echo $fnrl_info['pid'];?>">
                                                                                                                  
                                                            <div class="input-group-btn" style="padding-bottom: 5px;">
                                                                <button type="button" title="ตรวจสอบ" class="btn btn-default"  onClick="bt_elder_pid()" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                      ...
                                                      <script>
                                                        ...
                                                        //   $("#date_of_death").html(value.date_of_death);
                                                  ...
                                                  <input type="hidden" id="pren_code2" name="impv_info2[pren_code]" value="<?php echo $req_diff_info['pren_code'];?>">
                                                  <input type="hidden" id="pren_name2" name="impv_info2[pren_name]" value="<?php echo $req_prename2['prename_th'];?>">
                                                           
                                                  <input type="hidden" id="pers_firstname_th" name="impv_info2[pers_firstname_th]" value="<?php echo $pers_info['pers_firstname_th'];?>">
                                                  <input type="hidden" id="pers_lastname_th" name="impv_info2[pers_lastname_th]" value="<?php echo $pers_info['pers_lastname_th'];?>">
                                                  <input type="hidden" id="date_of_birth" name="impv_info2[date_of_birth]" value="<?php echo $pers_info['date_of_birth_num'];?>">
                                                  <input type="hidden" id="gender_code" name="impv_info2[gender_code]" value="<?php echo $pers_info['gender_code'];?>">

                                                  <input type="hidden"  name="impv_addr2[addr_home_no]" value="<?php echo $addr_pers_info2['addr_home_no'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_moo]" value="<?php echo $addr_pers_info2['addr_moo'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_alley]" value="<?php echo $addr_pers_info2['addr_alley'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_lane]" value="<?php echo $addr_pers_info2['addr_lane'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_road]" value="<?php echo $addr_pers_info2['addr_road'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_province]" value="<?php echo $addr_pers_info2['addr_province'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_district]" value="<?php echo $addr_pers_info2['addr_district'];?>">
                                                  <input type="hidden"  name="impv_addr2[addr_sub_district]" value="<?php echo $addr_pers_info2['addr_sub_district'];?>"> 
                                                 
                                                  <div class="form-group row">
                                                    <!-- <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ชื่อตัว/ชื่อสกุล</span></div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"  id="name"> <?php echo $fnrl_info['name'];?> </div>

                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span></div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="date_of_birth"> <?php echo $fnrl_info['date_of_birth'];?> </div> -->

                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ชื่อตัว/ชื่อสกุล</span><span id="name"><?php echo $req_prename2['prename_th'].' '.$fnrl_info['name'];  ?></span>
                                      
                                                  </div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span><span id="date_of_birth_sufferer"> <?php echo $fnrl_info['date_of_birth'];?></span></div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold; color:red">วันที่เสียชีวิต</span>
                                                    <!-- <span id="date_of_death" style="color:red;"> <?php //echo $fnrl_info['date_of_death'];?></span> -->
                                                        <div id="datetimepickerdeath" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                           <input title="วันที่เสียชีวิต" placeholder="เลือกวันที่" class="form-control" type="text" name="impv_date[date_of_death]" >
                                                           <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                       </div>
                                                    </div>
                                                      <script type="text/javascript">
                                                          <?php
                                                          $tmp1 = explode('-',@$pers_info['date_of_death']);
                                                          ?>
                                                          $(function () {
                                                          $("#datetimepickerdeath").datepicker({
                                                            autoclose: true,
                                                            todayHighlight: true,
                                                             format: 'dd/mm/yyyy',
                                                             todayBtn: true,
                                                             language: 'th',
                                                             thaiyear: true
                                                          })<?php if(count($tmp1)==3){?>.datepicker('update', new Date(Date.UTC(<?php echo $tmp1[2];?>,<?php echo $tmp1[1];?>-1,<?php echo $tmp1[0];?>)));<?php }?>
                                                          });
                                                      </script>
                                                  </div>
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6" style="padding: 7px 15px;"><span style="font-weight: bold;">ที่อยู่ตามทะเบียนบ้าน</span>
                                                    <span id="reg_addr"><?php echo @$fnrl_info['reg_add_info'];?></span> </div>
                                                    <input type="hidden" id="reg_addr_id" name="pers_info[reg_addr_id]" value="<?php echo @$fnrl_info['reg_add_info']; ?>">
                                                  </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         <span id="age_status_txt"><?php echo $fnrl_info['age_status']?></span>
                                        </td>
                                        <!-- <td id="row1_state"><i class="fa fa-times text-danger"></i></td> -->
                                    </tr>
                                    <tr>
                                        <td>
                                            <b>สถานะการเสียชีวิต</b> วัน/เดือน/ปีเสียชีวิต : <span id="row2_date_of_death"><?php echo $fnrl_info['death_date']?></span>
                                        </td>
                                        <td>
                                          กรมการปกครอง
                                        </td>
                                        <td>
                                          <span id="death_status_txt"><?php echo $fnrl_info['death_status']?></span>
                                        </td>
                                    ...
                                    -->
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <script>
                                                      ...
                                                      // console.log('hi',date_of_death);
                                                      // if(date_of_death){
                                                      //   console.log('death-'+date_of_death);
                                                      //  // $(".not_allowed").attr('disabled',false);
                                                      // }
                                                      // else{
                                                      //   //$(".not_allowed").attr('disabled',true);
                                                      //   console.log('not death-'+date_of_death);
                                                      // }
                                                      ...
                                                      ?>
                                                      <?php if( $addr_pers_info['addr_home_no']== $addr_pers_info2['addr_home_no'] 
                                                      && $addr_pers_info['addr_moo']== $addr_pers_info2['addr_moo'] 
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label"  style="color:red;">บ้านเลขที่</label>
                                                       ...
                                                       <input title="บ้านเลขที่" placeholder="ตัวอย่าง xxx/xx" class="form-control elder_addr_pre" style="border-color:red;" onkeyup="nonthnumber(this)" type="text" id="addr_home_no"  name="pers_addr[addr_home_no]" value="<?php echo @$addr_info['addr_home_no']; ?>" required/>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">หมู่ที่</label>
                                                        <input type="hidden" name="addr_moo_id" value="<?php echo @$addr_info['addr_moo']; ?>">
                                                        <input title="หมู่ที่" placeholder="" class="form-control elder_addr_pre"  onkeyup="housenumber(this)" type="text" id="addr_moo" name="pers_addr[addr_moo]" value="<?php echo @$addr_info['addr_moo']; ?>"/>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                        ...
                                                        <div class="col-10">
                                                          <input id="alley" title="ตรอก" placeholder="ตัวอย่าง บ้านหล่อ"  onkeyup="nonthnumandeng(this)" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_alley]" value="<?php echo @$addr_info['addr_alley']; ?>" />
                                                      </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                      <label for="example-text-input" class="col-2 col-form-label">ซอย</label>
                                                      <div class="col-10">
                                                        <input id="lane" title="ซอย" placeholder="ตัวอย่าง วรพงษ์" onkeyup="addressvalidate(this)" class="form-control elder_addr_pre" type="text" onkeyup="addressvalidate(this)" name="pers_addr[addr_lane]" value="<?php echo @$addr_info['addr_lane']; ?>" />
                                                      </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 dropdown">
                                                      <label for="example-text-input" class="col-2 col-form-label">ถนน</label>
                                                      <div class="col-10">
                                                        <input id="road" title="ถนน" placeholder="ตัวอย่าง ปรินายก" onkeyup="nonthnumandeng(this)" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_road]" value="<?php echo @$addr_info['addr_road']; ?>" />
                                                      </div>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        <input title="รหัสไปรษณีย์" placeholder="ระบุรหัสไปรษณีย์ (5 หลัก)" maxlength="5" onkeyup="numbervalid(this)" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_zipcode]" value="<?php echo @$addr_info['addr_zipcode']; ?>"/>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                      ...
                                                      <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" onkeyup="thnodash(this)" type="text" name="pers_info[tel_no]" value="<?php echo @$pers_info['tel_no'];?>"/>
                                                    </div>
                                                   
                                         
                                                      <div class="col-xs-12 col-sm-3 dropdown">
                                                        <label for="example-text-input" class="col-2 col-form-label">ถึงแก่กรรมด้วยสาเหตุ</label>
                                                         <select id="death_cause_code" title="สาเหตุการถึงแก่กรรม" placeholder="เลือกสาเหตุการถึงแก่กรรม" class="form-control" name="fnrl_info[death_cause]" >
                                                         <option value="">เลือกสาเหตุการถึงแก่กรรม</option>
                                                         <?php $tmp_cr = $this->common_model->custom_query("select * from std_cause_of_death");
                                                            foreach ($tmp_cr as $row) { ?>
                                                               <option value="<?php echo $row['cause_code'];?>" <?php if($row['cause_code'] == $fnrl_info['death_cause']){ echo "selected";} ?>><?php echo $row['cause_of_death']; ?></option>
                                                          <?php } ?>
                                                         </select>
                                                      </div>
                                                      <div class="col-xs-12 col-sm-6">
                                                        <label for="" class="col-2 col-form-label">&nbsp;</label>
                                                        <input id="other_death_cause_code" title="ระบุ" placeholder="อื่นๆ (ระบุ)" onkeyup="thvalidate(this)" class="form-control" type="text" name="fnrl_info[death_cause_identify]" value="<?php echo $fnrl_info['death_cause_identify']; ?>" <?php if($fnrl_info['death_cause_identify'] == "") { echo "disabled";} ?> />
                                                      </div>

                                                      <script type="text/javascript">
                                                      $("#death_cause_code").change(function () {
                                                        if($(this).val() == "009"){
                                                          $("#other_death_cause_code").prop('disabled', false ).focus();
                                                        }else{
                                                          $("#other_death_cause_code").val('');
                                                          $("#other_death_cause_code").prop('disabled', true );
                                                        }
                                                      });
                                                  ...
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        <input type="text" class="form-control death_certificate_no" name="fnrl_info[death_certificate_no]" value="<?php echo @$fnrl_info['death_certificate_no']; ?>" placeholder="ระบุใบมรณบัตร">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <label for="" class="col-2 col-form-label">ออกให้โดย</label><br>
                                                        <input type="text" class="form-control" onkeyup="thvalidate(this)" name="fnrl_info[death_certificate_org]" value="<?php echo @$fnrl_info['death_certificate_org']; ?>" placeholder="ระบุหน่วยงานที่ออกใบมรณบัตร (ชื่อเต็มเท่านั้น)">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                          ...
                                          <div class="panel-group" style="margin-bottom: 0px;">
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                               <div class="input-group" style="width: 330px;">
                                                                  ...
                                                                  <div class="input-group-btn" style="padding-bottom: 5px;">
                                                                    <button type="button" title="ตรวจสอบ" class="btn btn-default"  onClick="bt_req_pers_aprv_pid()"  style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                                    <button type="button" title="ล้างค่า" class="btn btn-default" id="bt_clear_req_aprv" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-close" aria-hidden="true"></i></button>
                                                                  </div>
                                                               </div>
                                                               <input type="hidden" id="pid_id3" name="impv_pid3[pid]" value="<?php echo $fnrl_info['req_pers_aprv_pid'];?>">
                                                            ...
                                                            <script>
                                                              ...
                                                              // var clear_req_pers_aprv_pers = "#bt_clear_req_aprv";
                                                              ...
                                                              // $(clear_req_pers_aprv_pers).click(function(value){
                                                              //   $("#req_pers_aprv_pid").val("");
                                                              //   $("#req_pers_aprv_name").html("");
                                                              //   $("#req_pers_aprv_date_of_birth").html("");
                                                              //   $("#req_pers_aprv_gender_name").html("");
                                                              //   $("#req_pers_aprv_nation_name_th").html("");
                                                              //   $("#req_pers_aprv_relg_title").html("");
                                                              //   $("#req_pers_aprv_pers_id").val("");
                                                              //   $("#req_pers_aprv_reg_addr").text("");
                                                              //   $("#req_pers_aprv_position").val("");
                                                              //   $("#date_of_req_pers_aprv").val("");
                                                              //   $("#req_pers_aprv_org").val("");
                                                              //   $("#req_pers_aprv_tel_no_mobile").val("");
                                                              // });
                                                            </script>
                                                          </div>
                                                          
                                                          <input type="hidden" id="pren_code3" name="impv_info3[pren_code]" value="<?php echo $req_diff_info4['pren_code'];?>">
                                                          <input type="hidden" id="pren_name3" name="impv_info3[pren_name]" value="<?php echo $req_prename3['prename_th'];?>">
                                                        
                                                          <input type="hidden"  name="impv_info3[pers_firstname_th]" value="<?php echo $req_diff_info4['pers_firstname_th'];?>">
                                                          <input type="hidden"  name="impv_info3[pers_lastname_th]" value="<?php echo $req_diff_info4['pers_lastname_th'];?>">
                                                          <input type="hidden" name="impv_info3[date_of_birth]" value="<?php echo $req_diff_info4['date_of_birth_num'];?>">
                                                          <input type="hidden"  name="impv_info3[gender_code]" value="<?php echo $req_diff_info4['gender_code'];?>">

                                                          <input type="hidden"  name="impv_addr3[addr_home_no]" value="<?php echo $addr_pers_info4['addr_home_no'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_moo]" value="<?php echo $addr_pers_info4['addr_moo'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_alley]" value="<?php echo $addr_pers_info4['addr_alley'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_lane]" value="<?php echo $addr_pers_info4['addr_lane'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_road]" value="<?php echo $addr_pers_info4['addr_road'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_province]" value="<?php echo $addr_pers_info4['addr_province'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_district]" value="<?php echo $addr_pers_info4['addr_district'];?>">
                                                          <input type="hidden"  name="impv_addr3[addr_sub_district]" value="<?php echo $addr_pers_info4['addr_sub_district'];?>"> 
                                                 
                                                          <div class="form-group row">
                                                          <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ชื่อตัว/ชื่อสกุล</span></div>
                                                          <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="req_pers_aprv_name"> <?php echo $req_prename3['prename_th'].' '.$fnrl_info['req_pers_aprv_name'];?> </div>

                                                          <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span></div>
                                                          <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="req_pers_aprv_date_of_birth"> <?php echo @$fnrl_info['req_pers_aprv_date_of_birth'];?> </div>
                                                          </div>
                                                          <div class="form-group row">  
                                                          ...
                                                          <div class="col-xs-12 col-sm-6" style="padding: 7px 15px;"><span style="font-weight: bold;">ที่อยู่ตามทะเบียนบ้าน</span>
                                                          <span id="req_pers_aprv_reg_addr"> <?php echo @$fnrl_info['req_pers_aprv_addr_info'];?></span> </div>
                                                          </div>
                                                        <div class="form-group row">
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="datetimepicker4" class="col-2 col-form-label">วันที่รับรอง </label>
                                                    <div id="datetimepicker4" class="col-10 input-group date" data-date-format="dd-mm-yyyy">
                                                        <input title="วันที่รับรอง" placeholder="เลือกวันที่" id="date_of_req_pers_aprv" class="form-control" type="text" name="fnrl_info[date_of_req_pers_aprv]" />
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                    </div>
                                                      <script type="text/javascript">
                                                                <?php
                                                          ...
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">ตำแหน่ง</label>
                                                              <input title="ตำแหน่ง" placeholder="ระบุตำแหน่ง" class="form-control" type="text" onkeyup="numberandth(this)" id="req_pers_aprv_position" name="fnrl_info[req_pers_aprv_position]" value="<?php echo $fnrl_info['req_pers_aprv_position'];?>"/>
                                                          </div>
                                                          <div class="col-xs-12 col-sm-6">
                                                              <label for="" class="col-2 col-form-label">หน่วยงาน</label>
                                                              <input title="หน่วยงานต้นสังกัด" placeholder="ระบุหน่วยงานต้นสังกัด (ชื่อเต็มเท่านั้น)" class="form-control" onkeyup="numberandth(this)" id="req_pers_aprv_org" type="text" name="fnrl_info[req_pers_aprv_org]" value="<?php echo $fnrl_info['req_pers_aprv_org'];?>"/>
                                                          </div>
                                                ...
                                                <div class="form-group row">
                                                  ...
                                                  <div class="col-xs-12 col-sm-3">
                                                    <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (ที่ติดต่อได้)</label>
                                                    <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX"  onkeyup="thnodash(this)" class="form-control" type="text" id="req_pers_aprv_tel_no_mobile" name="fnrl_info[req_pers_aprv_tel_no_mobile]" value="<?php echo $fnrl_info['req_pers_aprv_tel_no_mobile'];?>"/>
                                                  </div>
                                                    ...
                                                    <div class="panel-group" style="margin-bottom: 0px;">
                                                          <div class="panel panel-default" style="border: 0">
                                                              <div class="panel-heading"><h4>ข้อมูลผู้รับรอง กรณีไม่มีบัตรสวัสดิการแห่งรัฐ</h4></div>
                                                              <div class="panel-body" style="border:0; padding: 20px;">
                                                                  <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                                      <div class="input-group" style="width: 330px;">
                                                                           <input  title="เลขประจำตัวประชาชน" placeholder="เลขประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard" type="text" value="<?php echo @$fnrl_info['not_survey_aprv_pid'];?>" name="fnrl_info[not_survey_aprv_pid]" id="not_survey_aprv_pid" autofocus />
                                                                           <input type="hidden" id="pid_id5" name="impv_pid5[pid]" value="<?php echo $fnrl_info['not_survey_aprv_pid'];?>">
                                                                          ...
                                                                          <div class="input-group-btn" style="padding-bottom: 5px;">
                                                                             <button type="button" title="ตรวจสอบ" class="btn btn-default" onClick="bt_not_survey_aprv_pid()" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                                             <button type="button" title="ล้างค่า" class="btn btn-default" id="bt_clear_not_survey_aprv" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-close" aria-hidden="true"></i></button>
                                                                          </div>
                                                                      </div>
                                                                      </div>
                                                                      <script>
                                                                        ...
                                                                        // var clear_not_survey_aprv = "#bt_clear_not_survey_aprv";
                                                                        ...
                                                                        // $(clear_not_survey_aprv).click(function(value){
                                                                        //   $("#not_survey_aprv_pid").val("");
                                                                        //   $("#not_survey_aprv_name").html("");
                                                                        //   $("#not_survey_aprv_date_of_birth").html("");
                                                                        //   $("#not_survey_aprv_gender_name").html("");
                                                                        //   $("#not_survey_aprv_nation_name_th").html("");
                                                                        //   $("#not_survey_aprv_relg_title").html("");
                                                                        //   $("#not_survey_aprv_pers_id").val("");
                                                                        //   $("#not_survey_aprv_reg_addr").text("");
                                                                        //   $("#date_of_not_survey_aprv").val("");
                                                                        //   $("#not_survey_aprv_position").val("");
                                                                        //   $("#not_survey_aprv_org").val("");
                                                                        //   $("#not_survey_aprv_tel_no_mobile").val("");
                                                                        // });
                                                                      </script>
                                                                  </div>
                                                                 
                                                                  <input type="hidden" id="pren_code5" name="impv_info5[pren_code]" value="<?php echo $req_diff_info5['pren_code'];?>">
                                                                  <input type="hidden" id="pren_name5" name="impv_info5[pren_name]" value="<?php echo $req_prename4['prename_th'];?>">
                                                        
                                                                  <input type="hidden"  name="impv_info5[pers_firstname_th]" value="<?php echo $req_diff_info5['pers_firstname_th'];?>">
                                                                  <input type="hidden"  name="impv_info5[pers_lastname_th]" value="<?php echo $req_diff_info5['pers_lastname_th'];?>">
                                                                  <input type="hidden" name="impv_info5[date_of_birth]" value="<?php echo $req_diff_info5['date_of_birth_num'];?>">
                                                                  <input type="hidden"  name="impv_info5[gender_code]" value="<?php echo $req_diff_info5['gender_code'];?>">

                                                                  <input type="hidden"  name="impv_addr5[addr_home_no]" value="<?php echo $addr_pers_info5['addr_home_no'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_moo]" value="<?php echo $addr_pers_info5['addr_moo'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_alley]" value="<?php echo $addr_pers_info5['addr_alley'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_lane]" value="<?php echo $addr_pers_info5['addr_lane'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_road]" value="<?php echo $addr_pers_info5['addr_road'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_province]" value="<?php echo $addr_pers_info5['addr_province'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_district]" value="<?php echo $addr_pers_info5['addr_district'];?>">
                                                                  <input type="hidden"  name="impv_addr5[addr_sub_district]" value="<?php echo $addr_pers_info5['addr_sub_district'];?>"> 
                                                        
                                                                  <div class="form-group row">
                                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ชื่อตัว/ชื่อสกุล</span></div>
                                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="not_survey_aprv_name"> <?php echo $req_prename4['prename_th'].' '.$fnrl_info['not_survey_aprv_name'];?> </div>

                                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span></div>
                                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;" id="not_survey_aprv_date_of_birth"> <?php echo @$fnrl_info['not_survey_aprv_date_of_birth'];?> </div>
                                                                   </div> 
                                                                   <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ที่อยู่ตามทะเบียนบ้าน</span>
                                                                    <span id="not_survey_aprv_reg_addr"> <?php echo @$fnrl_info['not_survey_aprv_reg_addr_info']; ?></span> </div>
                                                                    </div>
                                                                  </div>
                                                                  <div class="form-group row">
                                                                    <div class="col-xs-12 col-sm-3">
                                                                      <label for="datetimepicker5" class="col-2 col-form-label">วันที่รับรอง </label>
                                                                   <div id="datetimepicker5" class="col-10 input-group date" data-date-format="dd-mm-yyyy">
                                                                  <input title="วันที่รับรอง" placeholder="เลือกวันที่" id="date_of_not_survey_aprv" class="form-control" type="text" name="fnrl_info[date_of_not_survey_aprv]" />
                                                                  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                              </div>
                                                                <script type="text/javascript">
                                                                <?php
                                                                ...
                                                                $("#datetimepicker5").datepicker({
                                                                  ...
                                                                  format: 'dd/mm/yyyy',
                                                                   ...
                                                                   thaiyear: true
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-3">
                                                                        <label for="" class="col-2 col-form-label">ตำแหน่ง</label>
                                                                        <input title="ตำแหน่ง" placeholder="ระบุตำแหน่ง" class="form-control" id="not_survey_aprv_position" onkeyup="numberandth(this)" type="text" name="fnrl_info[not_survey_aprv_position]" value="<?php echo @$fnrl_info['not_survey_aprv_position'];?>"/>
                                                                    </div>
                                                                    <div class="col-xs-12 col-sm-6">
                                                                        <label for="" class="col-2 col-form-label">หน่วยงาน</label>
                                                                        <input title="หน่วยงานต้นสังกัด" placeholder="ระบุหน่วยงานต้นสังกัด (ชื่อเต็มเท่านั้น)" id="not_survey_aprv_org" onkeyup="numberandth(this)" class="form-control" type="text" name="fnrl_info[not_survey_aprv_org]" value="<?php echo @@$fnrl_info['not_survey_aprv_org'];?>"/>
                                                                    </div>
                                                          ...
                                                          <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (ที่ติดต่อได้)</label>
                                                              <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX"  onkeyup="thnodash(this)" id="not_survey_aprv_tel_no_mobile" class="form-control" type="text" name="fnrl_info[not_survey_aprv_tel_no_mobile]" value="<?php echo @$fnrl_info['not_survey_aprv_tel_no_mobile'];?>"/>
                                                            </div>
...
var integration1 = function(info) {
  ...
  if(info.age>=60) {
    ...
    $("#age_status_txt").html("มากกว่า 60 ปีขึ้นไป");
  }else {
    info.date_of_birth = info.date_of_birth==''?'-':info.date_of_birth;
...
function cardInfo(){
    ...
    $.ajax({  
                    ...
                    success: function(data_service) {
                     //console.log(data_service.personal)                         
...
function bt_elder_pid(){
    ...
    $.ajax({  
          ...
          success: function(data_token) {
              ...
              $.ajax({
              type: "POST",
              url: base_url+"funeral/getDataDead/",
                ...
                success: function(data){ 
                 // console.log(data)        
                    ...
                    $.ajax({
                      type: "POST",
                      url: base_url+"/adaptenvir/getDataPid/",
                      data: { req_pid : pid_id,tokenId : data_token,csrf_dop : csrf_hash},
                      success: function(data){
                        //console.log(data)
                        if (pid_id == "_-____-_____-__-_" || pid_id == "") { 
                          closeloadswal();
                          toastr.error("โปรดตรวจสอบข้อมูลเลขบัตรประจำตัวประชาชนผู้สูงอายุ", "หน้าต่างแจ้งเตือน");   
                          ...
                          if (!!data.firstName) {                               
                            ...
                            $.ajax({
                              ...
                              data: {title_name : titleName,csrf_dop : csrf_hash},
                              success: function(data){                                    
                                $('#pren_code2').val(data.pren_code);  
                                $('#pren_name2').val(data.prename_th);                                     
                              },
                              dataType: "json",
                            });                      
...
function bt_req_pers_aprv_pid(){

  var pid_id = $('#req_pers_aprv_pid').val();
  var reqId = pid_id.replaceAll("-","");
  $('#pid_id3').val(reqId); 
  showloadersc('warning','กรุณารอสักครู่ กำลังโหลดข้อมูล !');
  $.ajax({  
                  ...
                  if (!!data.firstName && !!data.lastName) {                               
                    ...
                    $.ajax({
                      ...
                      success: function(data){
                        ...
                        $('#req_pers_aprv_date_of_birth').html(data); 
                    ...
                    $.ajax({
                      ...
                      data: {title_name : titleName,csrf_dop : csrf_hash},
                      success: function(data){                                    
                        $('#pren_code3').val(data.pren_code);  
                        $('#pren_name3').val(data.prename_th);                                     
                      },
                      dataType: "json",
                    });  
                    
                    $('#req_pers_aprv_name').html(data.titleName+' '+data.firstName+' '+data.lastName);                              
                    // $('#date_of_birth_sufferer').html(data.dateOfBirth);
                    $('#req_pers_aprv_gender_name').html(data.genderDesc);            
                    $('input[name="impv_info3[pers_firstname_th]"]').val(data.firstName);
                    $('input[name="impv_info3[pers_lastname_th]"]').val(data.lastName);
                    $('input[name="impv_info3[gender_code]"]').val(data.genderCode);
                    $('input[name="impv_info3[date_of_birth]"]').val(varBirthday);      
                    $.ajax({
                      type: "POST",
                      url: base_url+"/adaptenvir/getAddress/",
                      // data: {req_pid : $('#req_pid').val(),tokenId : data_token,csrf_dop : csrf_hash},
                      ...
                      success: function(dataAdderss){
                        //console.log(dataAdderss)
                      var addressname = dataAdderss.houseNo +' หมู่ที่ '+dataAdderss.villageNo +' '+' ตำบล'+dataAdderss.subdistrictDesc +' '+' อำเภอ'+dataAdderss.districtDesc +' '+' จังหวัด'+dataAdderss.provinceDesc;
                        $('#req_pers_aprv_reg_addr').html(addressname);         
                        $('input[name="impv_addr3[addr_moo]"]').val(dataAdderss.villageNo);                        
                          $('input[name="impv_addr3[addr_home_no]"]').val(dataAdderss.houseNo);
                          $('input[name="impv_addr3[addr_lane]"]').val(dataAdderss.roadDesc);
                          $('input[name="impv_addr3[addr_alley]"]').val('');
                          $('input[name="impv_addr3[addr_road]"]').val('');
                          var province = dataAdderss.provinceDesc.replace("จังหวัด","");
                          var amphur = dataAdderss.districtDesc.replace("อำเภอ","");
                          var tambol = dataAdderss.subdistrictDesc.replace("ตำบล","");
                          ...
                          $.ajax({
                            ...
                            success: function(dataArea){
                              // console.log('>>>>>>>>',dataArea)
                              closeloadswal();					
                              $('input[name="impv_addr3[addr_province]"]').val(dataArea.province_code);		
                              $('input[name="impv_addr3[addr_district]"]').val(dataArea.amphur_code);
                              $('input[name="impv_addr3[addr_sub_district]"]').val(dataArea.tambol_code);		
...
function bt_not_survey_aprv_pid(){

    var pid_id = $('#not_survey_aprv_pid').val();
    var reqId = pid_id.replaceAll("-","");
    $('#pid_id5').val(reqId); 
    showloadersc('warning','กรุณารอสักครู่ กำลังโหลดข้อมูล !');
    $.ajax({  
                    ...
                    if (!!data.firstName && !!data.lastName) {                               
                      ...
                      $.ajax({
                        ...
                        success: function(data){
                          ...
                          $('#not_survey_aprv_date_of_birth').html(data); 
                      ...
                      $.ajax({
                        ...
                        data: {title_name : titleName,csrf_dop : csrf_hash},
                        success: function(data){                                    
                          $('#pren_code5').val(data.pren_code);  
                          $('#pren_name5').val(data.prename_th);                                     
                        },
                        dataType: "json",
                      });                        
                      
                      $('#not_survey_aprv_name').html(data.titleName+' '+data.firstName+' '+data.lastName);                              
                      // $('#date_of_birth_sufferer').html(data.dateOfBirth);
                      $('#not_survey_aprv_gender_name').html(data.genderDesc);            
                      $('input[name="impv_info5[pers_firstname_th]"]').val(data.firstName);
                      $('input[name="impv_info5[pers_lastname_th]"]').val(data.lastName);
                      $('input[name="impv_info5[gender_code]"]').val(data.genderCode);
                      $('input[name="impv_info5[date_of_birth]"]').val(varBirthday);      
                      $.ajax({
                        type: "POST",
                        url: base_url+"/adaptenvir/getAddress/",
                        // data: {req_pid : $('#req_pid').val(),tokenId : data_token,csrf_dop : csrf_hash},
                        ...
                        success: function(dataAdderss){
                          //console.log(dataAdderss)
                        var addressname = dataAdderss.houseNo +' หมู่ที่ '+dataAdderss.villageNo +' '+' ตำบล'+dataAdderss.subdistrictDesc +' '+' อำเภอ'+dataAdderss.districtDesc +' '+' จังหวัด'+dataAdderss.provinceDesc;
                          $('#not_survey_aprv_reg_addr').html(addressname);         
                          $('input[name="impv_addr5[addr_moo]"]').val(dataAdderss.villageNo);                        
                            $('input[name="impv_addr5[addr_home_no]"]').val(dataAdderss.houseNo);
                            $('input[name="impv_addr5[addr_lane]"]').val(dataAdderss.roadDesc);
                            $('input[name="impv_addr5[addr_alley]"]').val('');
                            $('input[name="impv_addr5[addr_road]"]').val('');
                            var province = dataAdderss.provinceDesc.replace("จังหวัด","");
                            var amphur = dataAdderss.districtDesc.replace("อำเภอ","");
                            var tambol = dataAdderss.subdistrictDesc.replace("ตำบล","");
                            ...
                            $.ajax({
                              ...
                              success: function(dataArea){
                                closeloadswal();
                                // console.log('>>>>>>>>',dataArea)					
                                $('input[name="impv_addr5[addr_province]"]').val(dataArea.province_code);		
                                $('input[name="impv_addr5[addr_district]"]').val(dataArea.amphur_code);
                                $('input[name="impv_addr5[addr_sub_district]"]').val(dataArea.tambol_code);		
