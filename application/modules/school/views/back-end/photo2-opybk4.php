                                                ...
                                                <div class="form-group row" style="margin-bottom:0px !important;"><!-- remove space bottom opal -->
                                                  <div class="col-xs-12 col-sm-12">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <br />
                                                        <button id="goto_tab1" style="height: 40px;width: 100% !important;" type="button" class="btn btn-primary btn-add" onclick="modalAddAlbum(this)" data-id="<?php echo $schl_id_original;?>" data-albumid="<?php echo $album_id;?>"> <i class="fa fa-plus-circle" aria-hidden="true"></i> เพิ่มอัลบั้มภาพ</button>
                                                        ...
                                                        ?>
                                                                ...
                                                                <div class="col-xs-12 col-sm-4 col-lg-3 element center"   style="margin-top: 20px; height:300px; word-wrap: break-word;">
                                                                      <div class="container3">
                                                                        ...
                                                                        <div class="overlay2">
                                                                          <!-- <input type="checkbox" class="che_del" >  --><span class="glyphicon glyphicon-pencil trashleft" title="ดูภาพทั้งหมด" aria-hidden="true" onclick="modalEditAlbum(this)" data-id="<?php echo $schl_id_original;?>" data-albumid="<?php echo $album_id;?>"></span>
...
<!--                                               <div class="panel-heading">
                                              ...
                                              <div class="panel-body" style="border:0; padding: 20px;"><!--3-->
                                                  ...
                                                  <!--กรอกข้อมูล รร-->
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-12" ><!-- <div class="col-xs-12 col-sm-12" id="parent_0"> -->
                                                  <!--                                                  <div class="col-xs-12 col-sm-9 has-error">
                                          ...
                                          <div class="form-group row" ><!--style="border-bottom: 1px solid #e5e5e5;"-->
                                            ...
                                            <div id="parent_0">
                                                          ...
                                                          <div class="col-xs-12 col-sm-4 col-lg-3 element"   style="margin-top: 20px; height:300px; word-wrap: break-word; font-size: 13px;">
                                                            ...
                                                            <input type="text" name="photo2[]" maxlength="25" style="width:202px; height:30px; margin-bottom:20px;" placeholder="สูงสุด 25 ตัวอักษร";> <!-- 270px, 210px -->
            ...
            <div class="modal-content"><!-- 3 -->
              ...
              <!-- <p>OPAL TEST MODAL</p> -->
                ...
                <!-- <h1><?php echo $_GET['albumid'];?></h1> -->
                                          ...
                                          <!-- === show image : start code === -->
                                          <!-- <div class="form-group row" > --><!--style="border-bottom: 1px solid #e5e5e5;"-->
                                            <!-- <div id="addAlbum-container" class="col-xs-12 col-sm-12">
                                          ...
                                          <div class="form-group row" ><!--style="border-bottom: 1px solid #e5e5e5;"-->
                                            ...
                                            <div id="parent_0">
                                                          ...
                                                          <div class="col-xs-12 col-sm-12 col-lg-12 element"   style="margin-top: 20px; height:150px; word-wrap: break-word; font-size: 13px;">
                                                            ...
                                                            <input type="text" name="photo2[]" maxlength="25" style="width:202px; height:30px; margin-bottom:20px;" placeholder="สูงสุด 25 ตัวอักษร"; required> <!-- 270px, 210px -->

                                                            <br />
                                                            
                                                            <text class="text-left">
                                                              <b style="color: ;">วันที่สร้างอัลบั้ม : </b>
                                                            </text>
                                                            ...
                                                            <input type="text" name="photo2[]" maxlength="25" style="width:100px; height:30px; margin-bottom:20px; color:lightgrey; background:transparent; border-width:0px !important" placeholder="วันนี้"; value="<?php echo formatDateThai1($date); ?>" disabled> <!-- 270px, 210px -->

                                                            <br />

                                                            <text class="text-left">
                                                              <b style="color: ;">คำอธิบายอัลบั้ม : </b>
                                                            </text>
                                                            
                                                            <input type="text" name="photo2[]" maxlength="45" style="width:400px; height:30px; margin-bottom:20px;" placeholder="สูงสุด 45 ตัวอักษร";> <!-- 270px, 210px -->
              ...
              <div class="modal-footer"><!-- 6 -->
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-3">
                    ...
                    <button style="height: 40px;width: 100% !important;" type="button" class="btn btn-primary btn-save btn-confirmadd" onclick="return opnCnAddAlbum()"> <i class="fa fa-floppy-o" aria-hidden="true"></i> บันทึก</button>
                  </div>
                  <div class="col-xs-12 col-sm-3">
                    <button style="height: 40px;width: 100% !important;" type="button" class="btn btn-primary btn-cancel" onclick="window.location.href='<?php echo site_url('school/school_list');?>'"> <i class="fa fa-caret-left" aria-hidden="true"></i> ย้อนกลับ</button>
                  </div>
