                                        ...
                                        <div class="form-group row" style="margin-bottom:0px !important;"><!-- remove space bottom opal -->
                                          <div class="col-xs-12 col-sm-12" style="padding-left: 30px; padding-right: 30px;">
                                            ...
                                            <div style="float: right;">
                                              ...
                                              <a class="navbar-minimalize minimalize-styl-2 btn btn-primary" style=" margin-left: 0px; background-color: #2f4250; border: 0;font-size: 17px; padding: 2px 20px 2px 20px;" onclick="modalAddGen(this)">
                                                    ...
                                                    <td align="center">
                                                      ...
                                                      <div class="btn-group" style="cursor: pointer;">
                                                          ...
                                                          <ul class="dropdown-menu" style="position: absolute;left: -210px;">
                                                              ...
                                                              <li>
                                                                  <a style="font-size:16px;" data-id="<?php echo $schl_id_original;?>" data-genid="<?php echo $gen_id;?>" onclick="modalActive(this)" >
...
<!--                                                   <div class="form-group row" style="padding-left: 15px; padding-right: 15px;">
                                                      ...
                                                      <div class="col-xs-12 col-sm-1 has-error" >
                                                          <input type="hidden" name="add_schl_gen[schl_id]" value="<?php echo $schl_id_original; ?>">
                                                          <label class="col-2 col-form-label" style="color: red;">รุ่นที่ </label>
                                                          <input type="number" min="1" placeholder="รุ่น" class="form-control" name="add_schl_gen[gen_code]" value="" title="" required>
                                                      </div>
                                                      ...
                                                      <div class="col-xs-12 col-sm-3">
                                                          ...
                                                          <div id="datetimepicker3" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                              <input title="วันที่เริ่มรุ่น" placeholder="เลือกวันที่" class="form-control" type="text" name="add_schl_gen[first_date_of_edu]" required />
...
<!--                                                       <div class="col-xs-12 col-sm-3">
                                                          ...
                                                          <div id="datetimepicker4" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                              <input title="วันที่จบรุ่น" placeholder="เลือกวันที่" class="form-control" type="text" name="add_schl_gen[last_date_of_edu]" required>
                                                              <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
...
<!--                                                       <div class="col-xs-12 col-sm-1">
                                                          ...
                                                          <input type="number" min="1" max="7" placeholder="วัน" name="add_schl_gen[days_per_week]" class="form-control" value="">
                                                      </div>

                                                      <div class="col-xs-12 col-sm-1">
                                                          <label class="col-2 col-form-label">ชม./สัปดาห์</label>
                                                          <input type="number" min="1" max="168" placeholder="ชม." name="add_schl_gen[hours_per_week]" class="form-control" value="">
                                                      </div>

                                                      <div class="col-xs-12 col-sm-3">
                                                          <label class="col-2 col-form-label">หลักสูตร</label>
                                                          <br>
                                                          <select id="crse_code" name="add_schl_gen[crse_code]" placeholder="เลือก หลักสูตร" class="form-control elder_addr_pre" >
                                                                <option selected disabled>เลือก หลักสูตร</option>
                                                              <?php 
                                                                $temp = $this->common_model->query("SELECT crse_code, crse_title FROM std_schl_edu_course order by crse_title ASC;")->result_array();
                                                                foreach ($temp as $key => $row) { ?>
                                                                <option value="<?php echo $row['crse_code']; ?>"> <?php echo $row['crse_title']; ?></option>
                                                              <?php  } ?>
                                                          </select>
                                                      </div>
...
<!--                                                               <div class="panel-group" style="margin-bottom:20px !important;">
                                                              ...
                                                              <div class="col-xs-12 col-sm-12 col-lg-12 element"   style="margin-top: 0px; margin-left: 25px; height: auto; word-wrap: break-word; font-size: 13px;">
                                                                      ...
                                                                      <input type="file" name="img3"  class="img_0" accept="image/*"  style="display: none;" onchange="imgchange(this,'');">
                                                                      <button id="btnAddimg2" type="button" class="btn btn-default" style="width: 138px; margin-top:20px;" onclick="brwImg(this,'');"><i class="fa fa-upload"></i> <?php echo $imgbuttonlabel; ?></button>      
