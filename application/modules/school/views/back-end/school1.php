<?php $schl_id_original = $schl_info['schl_id']; ?>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                              ...
                              ?>
                                <a  <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                  <?php }else if($process_action!='Add'){?> href="<?php echo site_url('school/school1/Edit/'.$schl_info['schl_id']);?>" <?php }?>  data-toggle="tab" <?php if($usrpm['app_id']==59){?>aria-expanded="true" <?php }else{?> aria-expanded="false"<?php }?>> (1) โรงเรียน</a>
                            </li>
                            <li>
                              <?php
                            ...
                            <li>
                              ...
                              ?>
                                <a  <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                  <?php }else if($process_action!='Add'){?> href="<?php echo site_url('school/school_model/Edit/'.$schl_info['schl_id']);?>" <?php }?>  <?php if($usrpm['app_id']==174){?>aria-expanded="true" <?php }else{?> aria-expanded="false"<?php }?>> (4) แบบประเมินโรงเรียน</a>
                            </li>
                        </ul>
                                                  ...
                                                  <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-3">
                                                            ...
                                                            <input title="เบอร์โทรศัพท์ (มือถือ)" placeholder="ตัวอย่าง 08XXXXXXX" name="schl_contacts[sch_cnt_tel_no][myID]" class="form-control" type="text"/>
                                                        </div>
                                              ...
                                              <div class="panel-body" style="border:0; padding: 20px;">
                                                ...
                                                <div class="form-group row">
                                                  <div class="col-xs-12 col-sm-9 has-error">
                                                      <label for="" class="col-2 col-form-label" style="color: red;">ชื่อโรงเรียน </label><!--ชื่อโรงเรียนxxx-->
                                                  ...
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        <select title="ศพอส." placeholder="เลือก ศพอส." class="form-control elder_addr_pre" id="qlc_id" name="schl_info[qlc_id]">
                                                            ...
                                                            <?php $temp = $this->common_model->custom_query("select * from qlc_info where delete_datetime IS NULL");
                                               ...
                                               <div class="form-group row">
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                        ...
                                                        <div class="col-10">
                                                          <select title="อำเภอ" placeholder="เลือกอำเภอ" class="form-control elder_addr_pre" id="Amphur" name="schl_info[addr_district]" onchange="optionGen(this,'Tambon',<?php echo @$schl_info['addr_sub_district']; ?>);" disabled> <!--this.value-->
                                          ...
                                          <div class="form-group row">
                                                  <div class="family_members" >
                                                       <?php if(($process_action!='Add')&&($process_action!='Added')){
                                                        ...
                                                        //$schl_contacts_2 = $this->common_model->custom_query("SELECT * FROM schl_info_contacts WHERE sch_id = $schl_id_original");
                                                                  ...
                                                                  <div class="panel-heading clear-fix" style="background-color: initial;">
                                                                    ...
                                                                    <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                                                                      ...
                                                                      <div class="form-group row">
                                                                          ...
                                                                          <div class="col-xs-12 col-sm-3">
                                                                              <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (มือถือ)</label>
                                                                              <input title="เบอร์โทรศัพท์ (มือถือ)" placeholder="ตัวอย่าง 08XXXXXXX" name="schl_contacts[sch_cnt_tel_no][<?php echo $i; ?>]" value="<?php echo $value_contacts['sch_cnt_tel_no']; ?>" class="form-control" type="text"/>
                                                                          </div>
                                                                        </div>
