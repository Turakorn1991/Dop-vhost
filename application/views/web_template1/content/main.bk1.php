...
<!-- 				<div class="col-lg-6 col-lg-offset-6">
					<p class="text-center font26 fontbold">นางไพรวรรณ  พลวัน<br>
						<span class="font20 fontb">อธิบดีกรมกิจการผู้สูงอายุ</span>
					</p>
				</div>
			</div> -->
<!-- 			<div class="col-lg-5" style="margin-top: 30px; margin-bottom: 30px; text-align:center;">
				<img src="http://phase2.dop.local.v7/assets/images/img.png" alt="..." height="450px">
				<p class="text-center font26 fontbold">นางไพรวรรณ  พลวัน<br>
					<span class="font20 fontb">อธิบดีกรมกิจการผู้สูงอายุ</span>
				</p>
			</div>
			<div>
			<div class="col-lg-7" style="margin-top: 180px; margin-bottom: 30px;">
				<div class="row">
					<div class="col-md-4" style="background-image: url('assets/images/workers.png'); background-size: 100%; background-repeat: no-repeat; padding-top: 100px;">
						<a href="<?php echo site_url('/login');?>" class="btn btn-default btn-block btn-statistics" target="_blank">
					...
					<div class="col-md-4" style="background-image: url('assets/images/happy_office_staff.png'); background-size: 100%; background-repeat: no-repeat; padding-top: 100px;">
						<a href="https://eis.dop.go.th" class="btn btn-default btn-block btn-statistics" target="_blank">
							<span class="font26 fontbold">รายงานผู้บริหาร</span><br><span class="font22">(EXCUTIVE INFO SYS.)</span>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-sm-4 item" style="padding-top: 10px; padding-bottom: 10px;"> <!--163ศพอส-->
								<a href="<?php echo site_url('/login');?>" target="_blank">
									<div class="col-sm-2 icon text-left" style="background-color: red">
										<i class="fa fa-heart-o" aria-hidden="true"></i>
									</div>
									<div class="col-sm-9 txt">
										<span class="fontbold">ระบบปฏิบัติการเจ้าหน้าที่</span><br><span class="">DATA CENTER</span>
									</div>
								</a>
							</div>
							
							<div class="col-sm-4 item" style="padding-top: 10px; padding-bottom: 10px;"> <!--163ศพอส-->
								<a href="https://gateway.dop.go.th/admin_login" target="_blank">
									<div class="col-sm-2 icon text-left" style="background-color: red">
										<i class="fa fa-heart-o" aria-hidden="true"></i>
									</div>
									<div class="col-sm-9 txt">
										<span class="fontbold">ระบบศูนย์แรกเปลี่ยนข้อมูล</span><br><span class="">DATA GATEWAY</span>
									</div>
								</a>
							</div>
							
							<div class="col-sm-4 item" style="padding-top: 10px; padding-bottom: 10px;"> <!--163ศพอส-->
								<a href="https://eis.dop.go.th" target="_blank">
									<div class="col-sm-2 icon text-left" style="background-color: red">
										<i class="fa fa-heart-o" aria-hidden="true"></i>
									</div>
									<div class="col-sm-9 txt">
										<span class="fontbold">ระบบข้อมูลสำหรับผู้บริหาร</span><br><span class="">DECISION SUPPORT SYSTEM (DSS)</span>
									</div>
								</a>
							</div>
...
<!-- 			<div class="col-md-12">
				<div class="row">
					<a href="<?php echo site_url('/login');?>" class="" target="_blank"> -->
					<!-- <div class="col-md-4" style="background-image: url('assets/images/workers.png'); background-size: 100%; background-repeat: no-repeat; padding-top: 100px;"> -->
<!-- 						<div class="col-md-4 btn btn-block btn-statistics" style="padding-top: 10px; padding-bottom: 10px;">
								<span class="font26 fontbold">ระบบปฏิบัติการเจ้าหน้าที่</span><br><span class="font26">DATA CENTER</span>
						</div>
					</a> -->
					<!-- <div class="col-md-4" style="background-image: url('assets/images/building_PNG70.png'); background-size: 100%; background-repeat: no-repeat; padding-top: 100px;"> -->
<!-- 					<div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
						<a href="https://gateway.dop.go.th/admin_login" class="btn btn-default btn-block btn-statistics" target="_blank">
							<span class="font26 fontbold">ระบบศูนย์แรกเปลี่ยนข้อมูล</span><br><span class="font26">DATA GATEWAY</span>
						</a>
					</div> -->
					<!-- <div class="col-md-4" style="background-image: url('assets/images/happy_office_staff.png'); background-size: 100%; background-repeat: no-repeat; padding-top: 100px;"> -->
<!-- 					<div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
						<a href="https://eis.dop.go.th" class="btn btn-default btn-block btn-statistics" target="_blank">
							<span class="font26 fontbold">ระบบข้อมูลสำหรับผู้บริหาร</span><br><span class="font22">DECISION SUPPORT SYSTEM (DSS)</span>
						</a>
					</div>
				</div>
			</div>
