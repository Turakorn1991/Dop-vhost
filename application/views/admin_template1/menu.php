...
<body>
            ...
            <div class="container" style="min-height: 600px;">
               ...
               <div class="row permiss_head" >
                    ...
                    <div class="col-xs-12 col-sm-4 permiss_head-panel" title="ด้านการพัฒนาศักยภาพผู้สูงอายุ">
                        ...
                        <div class="row">
                            <form action="http://www.kpy.dop.go.th/home/check_login" method="POST" target="_blank">
                              <div class="col-sm-12 item">
                                <?php
                                ...
                                $kpy = array();
                                if ($tmp1['perm_view'] == 'All')
                                  $kpy = array('username' => 'admin_kp', 'password' => '1234');
                                if ($tmp1['perm_view'] == 'Organization') {
                                  $province = $this->admin_model->get_KPYProvinceByOrgId(get_session('org_id'));
                                  $kpy = array('username' => $province, 'password' => '1234');
                                }
                                ?>
                                <input type="hidden" name="username" value="<?=$kpy["username"]?>" />
                                <input type="hidden" name="password" value="<?=$kpy['password']?>" />
                                <script>console.log('session',<?php echo json_encode(get_session('user_firstname'));?>);</script>
                                <?php if (!isset($tmp1['perm_status'])) { ?>
                                <a class="disabled">
                                <?php } else { ?>
                                <!-- <a href="<?php echo site_url('intelprop/intelprop_list');?>" -->
                                <a id='goKPY'>
                                <?php } ?>
                                  <div class="col-sm-2 icon text-left" style="background-color: <?php echo $tmp['app_color'];?>">
                                      <i class="<?php echo $tmp['app_icon'];?>" aria-hidden="true"></i>
                    ...
                    <div class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0" title="ด้านการเตรียมความพร้อมสู่วัยผู้สูงอายุ">
                        ...
                        <div class="row">
                            <div class="col-sm-12 item">
                                ...
                                $enable = isset($tmp1['perm_status']);
                                $session = $this->session->userdata();
                                if ($enable):
                                ?>
                                <form id='prepare_to_old' action="https://gold.dop.go.th/login/backend-dop-center" method="post" target='_blank'>
                                    <input type='hidden' name='passport' value='' />
                                </form>
                                <?php endif; ?>

                                <a <?php echo $enable ? 'id="submit_prepare_to_old"' : 'class="disabled"';?>>
                                    <div class="col-sm-2 icon text-left" style="background-color: <?php echo $tmp['app_color'];?>">
                                        <i class="<?php echo $tmp['app_icon'];?>" aria-hidden="true"></i>
                                    </div>
                                    <div class="col-sm-9 txt">
                            ...
                            <div class="col-sm-12 item"> <!--163ศพอส-->
                                <a
                                <?php
                                ...
                                if(!isset($tmp1['perm_status'])) { ?>
                                     class="disabled"
                                <?php }else{?>href="<?php echo site_url('school/center_list');?>"<?php }?>>
                                    <div class="col-sm-2 icon text-left" style="background-color: <?php echo $tmp['app_color'];?>">
                                        <i class="<?php echo $tmp['app_icon'];?>" aria-hidden="true"></i>
                                    </div>
                                    <div class="col-sm-9 txt">
                                    <?php if(isset($tmp['app_name'])){echo $tmp['app_name'];}?>
                                    <?php //echo 'ศูนย์พัฒนาคุณภาพชีวิตและส่งเสริมอาชีพผู้สูงอายุ (ศพอส.)';?>
                                    </div>
                                </a>
                            </div>
                        </div>
               ...
               <div class="row permiss_head" style="border-top: 1px solid rgba(255,255,255,0.4);" >
                    ...
                    <div class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        ...
                        <div class="row">
                            <div class="col-sm-12 item">
                                ...
                                if ($enable):
                                ?>
                                <form id='CMS_tool' action="https://gold.dop.go.th/login/backend-cms" method="post" target='_blank' enctype="multipart/form-data">
                                    <input type='hidden' name='passport' value='' />
                                </form>
                                <?php endif; ?>

                                <a <?php echo $enable ? 'id="submit_CMS_tool"' : 'class="disabled"';?>>
                                    <div class="col-sm-2 icon text-left" style="background-color: <?php echo $tmp['app_color'];?>">
                                        <i class="<?php echo $tmp['app_icon'];?>" aria-hidden="true"></i> <!-- hide icon -->
                                        <!-- <text style="padding-left:0.2em; padding-right:0.2em;">G</text> -->
                                    </div>
                                    <div class="col-sm-9 txt">
                                    <?php if(isset($tmp['app_name'])){echo $tmp['app_name'];}?>
                                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        ...
                        <div class="row">
                            ...
                            <a href="<?php echo base_url('/assets/file/program.zip'); ?>" title="Download File" Download>
                                    <div class="col-sm-2 icon text-left" style="background-color: #f7c93f">
                                        <i class="fa fa-download" aria-hidden="true"></i>                                        
                                    </div>
                                    <div class="col-sm-9 txt">
                                    ดาวน์โหลดโปรแกรมอ่านหน้าบัตร ปชช
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-4 permiss_head-panel" style="border-right:0">
                        ...
                        <div class="row">
                            ...
                            <a href="<?php echo base_url('/assets/file/คู่มือและการตั้งค่าระบบ.zip'); ?>" title="Download File" Download>
                                    <div class="col-sm-2 icon text-left" style="background-color: #548235">
    ...
    <script>
        $(function() {
            $('#goKPY').click(function() {
                $(this).parents('form').submit();
            });
            // $('#submit_CMS_tool').click(() => $('#CMS_tool').submit());
            $('#submit_CMS_tool').click(function() {
                var _userid = '<?php echo get_session('user_id'); ?>';
                var _pid = '<?php echo get_session('pid'); ?>';
                $.ajax({
                    type: "POST",
                    url: "/api/backendcms/gentoken",
                    dataType: "json",
                    data: {pid : _pid,userid :_userid},
                    success: function(response){
                        var url_link = "https://gold-admin.dop.go.th/Login/Signin?AuthenKey="+response.token;
                        window.location.href = url_link;
                    }
                });
            });
            $('#submit_prepare_to_old').click(() => $('#prepare_to_old').submit());
        });
    </script>
</html>
