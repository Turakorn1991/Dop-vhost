$(document).ready(function () {
	$(".btn-save").click(function () {
		...
		} else if ($("input[name='impv_info[pers_firstname_th]']").val() === "") {
			toastr.error("โปรดตรวจสอบข้อมูลผู้ยืนคำขอ", "หน้าต่างแจ้งเตือน");
		}else if ($("input[name='impv_info2[pers_firstname_th]']").val() === "") {
			toastr.error("โปรดตรวจสอบข้อมูลผู้สูงอายุ(ผู้สูงอายุที่เสียชีวิต)", "หน้าต่างแจ้งเตือน");
		}else if ($("input[name='impv_info3[pers_firstname_th]']").val() === "") {
			toastr.error("โปรดตรวจสอบข้อมูลข้อมูลผู้รับรอง", "หน้าต่างแจ้งเตือน");
		}else if ($("#name").html() === " - ") {
			toastr.error("โปรดตรวจสอบข้อมูลเลขบัตรประจำตัวประชาชนผู้สูงอายุที่เสียชีวิต", "หน้าต่างแจ้งเตือน");
	...
	$("#elder_addr_chk").on("ifClicked",function() {
		if(!$(this).prop("checked")){			
			...
			$.ajax({
				...
				data: {req_pid : $('#pid_id2').val(),tokenId : tokenRequest,csrf_dop : csrf_hash},
